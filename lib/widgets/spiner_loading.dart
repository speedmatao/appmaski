...
class SpinnerPage extends StatefulWidget {
  const SpinnerPage({Key? key, this.chiquito, this.color}) : super(key: key);
...
class SpinnerPageState extends State<SpinnerPage>
  ...
  Widget build(BuildContext context) {
    bool chiquito = widget.chiquito ?? false;
    return SizedBox(
      height: chiquito ? 50 : 100,
      width: chiquito ? 50 : 100,
      child: CustomPaint(
        painter: MyPainter(
...
class MyPainter extends CustomPainter {
  ...
  MyPainter(this.firstAngle, this.secondAngle, this.thirdAngle,
      this.fourthAngle, this.fifthAngle, this.chiquito, this.color);

  @override
  void paint(Canvas canvas, Size size) {
    Paint myArc = Paint()
      ..color = color ?? LightColors().kGreen
      ..style = PaintingStyle.stroke
      ..strokeWidth = chiquito ? 1 : 5
